...
// #MARK - Constructors
    ...
    public HeartProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.HeartProgressView, 0, 0);
        try {
            int heartColor = typedArray.getColor(R.styleable.HeartProgressView_heartColor, Color.parseColor("#FF4351"));
